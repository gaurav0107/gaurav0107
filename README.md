...
<!-- OSS:START -->
_last synced · 2026-05-15_

```
┌─ impact ──────────────────────────────────────────────────────────────┐
│ 12 merged  ·  11 open  ·  1.2M⭐ reached
...
|---|---:|---|---|---|
| [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) | 182k | [#1701](https://github.com/affaan-m/everything-claude-code/pull/1701) [#1682](https://github.com/affaan-m/everything-claude-code/pull/1682) [#1669](https://github.com/affaan-m/everything-claude-code/pull/1669) [#1490](https://github.com/affaan-m/everything-claude-code/pull/1490) | — | docs(strategic-compact): fix hook command path in zh-CN/zh-TW/ja-JP... |
...
| [google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli) | 103k | [#25822](https://github.com/google-gemini/gemini-cli/pull/25822) | [#27068](https://github.com/google-gemini/gemini-cli/pull/27068) | test: add validation tests for esbuild and eslint config |
...
| [danny-avila/LibreChat](https://github.com/danny-avila/LibreChat) | 37k | [#12825](https://github.com/danny-avila/LibreChat/pull/12825) | — | 🧹 fix: Graceful MCP OAuth Revoke Cleanup When Tokens Are Missing |
| [LambdaTest/agent-skills](https://github.com/LambdaTest/agent-skills) | 277 | [#5](https://github.com/LambdaTest/agent-skills/pull/5) [#4](https://github.com/LambdaTest/agent-skills/pull/4) [#3](https://github.com/LambdaTest/agent-skills/pull/3) | — | feat(api): standardize frontmatter, update validation, register 24 ... |
| [LambdaTest/kane-cli](https://github.com/LambdaTest/kane-cli) | 13 | [#25](https://github.com/LambdaTest/kane-cli/pull/25) | — | docs: document pnpm install as unsupported (#24) |
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | 371k | — | [#70287](https://github.com/openclaw/openclaw/pull/70287) | fix(msteams): drop unsupported $search on msteams:search (AI-assisted) |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 150k | — | [#18552](https://github.com/NousResearch/hermes-agent/pull/18552) | fix(weixin): steer agent to images or list format for wide tables (... |
...
| [langchain-ai/langchain-google](https://github.com/langchain-ai/langchain-google) | 374 | — | [#1708](https://github.com/langchain-ai/langchain-google/pull/1708) | fix(genai): wrap batch texts in Content objects for correct embeddi... |
