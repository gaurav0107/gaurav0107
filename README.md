...
|---|---:|---|---|---|
| [affaan-m/ECC](https://github.com/affaan-m/ECC) | 202k | [#2041](https://github.com/affaan-m/ECC/pull/2041) [#1701](https://github.com/affaan-m/ECC/pull/1701) [#1682](https://github.com/affaan-m/ECC/pull/1682) [#1669](https://github.com/affaan-m/ECC/pull/1669) [#1490](https://github.com/affaan-m/ECC/pull/1490) | — | fix(install-targets): validate compiled OpenCode plugin before install |
...
| [LambdaTest/agent-skills](https://github.com/LambdaTest/agent-skills) | 303 | [#5](https://github.com/LambdaTest/agent-skills/pull/5) [#4](https://github.com/LambdaTest/agent-skills/pull/4) [#3](https://github.com/LambdaTest/agent-skills/pull/3) | — | feat(api): standardize frontmatter, update validation, register 24 ... |
...
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 176k | — | [#18552](https://github.com/NousResearch/hermes-agent/pull/18552) | fix(weixin): steer agent to images or list format for wide tables (... |
