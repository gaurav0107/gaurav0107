...
|---|---:|---|---|---|
| [affaan-m/everything-claude-code](https://github.com/affaan-m/everything-claude-code) | 185k | [#1701](https://github.com/affaan-m/everything-claude-code/pull/1701) [#1682](https://github.com/affaan-m/everything-claude-code/pull/1682) [#1669](https://github.com/affaan-m/everything-claude-code/pull/1669) [#1490](https://github.com/affaan-m/everything-claude-code/pull/1490) | — | docs(strategic-compact): fix hook command path in zh-CN/zh-TW/ja-JP... |
...
| [danny-avila/LibreChat](https://github.com/danny-avila/LibreChat) | 37k | [#12825](https://github.com/danny-avila/LibreChat/pull/12825) | [#13171](https://github.com/danny-avila/LibreChat/pull/13171) | refactor: type the agent MCP lean projection in ServerConfigsDB |
...
| [openclaw/openclaw](https://github.com/openclaw/openclaw) | 372k | — | [#70287](https://github.com/openclaw/openclaw/pull/70287) | fix(msteams): drop unsupported $search on msteams:search (AI-assisted) |
| [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 155k | — | [#18552](https://github.com/NousResearch/hermes-agent/pull/18552) | fix(weixin): steer agent to images or list format for wide tables (... |
